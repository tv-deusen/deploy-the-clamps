...
export type ConfigValue = string | number | boolean | null | SecretReference;
...
export interface NetworkConfigDocument extends ConfigDocumentBase {
  ...
  readonly firewall?: {
    readonly provider: string;
    readonly inboundRules: readonly {
...
export interface LoadedConfig {
  ...
  readonly documentsByKind: ReadonlyMap<ConfigDocumentKind, readonly ConfigDocument[]>;
}
